...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.swift.com/oauth2/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("clientAuth", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.swift.com/oauth2/v1
